...
- (UIImageView *)platformLogoForWidth:(CGFloat)width height:(CGFloat)height;
- (NSURL *)optOutUrl;
...
- (void)registerViewForInteraction:(UIView<STRAdView> *)view withViewController:(UIViewController *)viewController delegate:(id<STRAdViewDelegate>) delegate;
