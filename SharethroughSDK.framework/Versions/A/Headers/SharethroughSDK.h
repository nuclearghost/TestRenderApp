...
/**
 This method enable trace logging for debugging purposes. This should be called before SDK is used. For production builds, this method should not be called.
 */
