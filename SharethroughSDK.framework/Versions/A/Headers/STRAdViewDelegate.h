...
/**
 This delegate method will be called when an ad in clicked.
 @param StrAd The ad meta data
 @return YES to show engagement modal or NO to not show engagement modal
 */
- (BOOL)handleAdClick:(STRAdvertisement *)strAd;
